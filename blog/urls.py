...
urlpatterns = [
    ...
    path('blogs/update_is_listed/', views.BlogUpdateIsListedView.as_view(),
         name='blog-update-is-listed'),
    ...
    path('blogs/report/<int:pk>/',
         views.ReportBlogView.as_view(), name='report-blog'),
    path('blogs/save/', views.SaveBlogView.as_view(), name='save-blog'),
    path('comments/edit/<int:pk>/',
         views.CommentEditView.as_view(), name='edit-comment'),
    path('comments/delete/<int:pk>/',
         views.CommentDeleteView.as_view(), name='delete-comment'),
    path('blog-update/<int:id>/', views.BlogDetailUpdateDeleteView.as_view(),
         name='blog-detail-update-delete'),
    path('user-saved-blogs/', views.UserSavedBlogs.as_view(),
         name='user-saved-blogs'),
    path('user-liked-blogs/', views.UserLikedBlogs.as_view(),
         name='user-liked-blogs'),
]
