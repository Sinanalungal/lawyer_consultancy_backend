    ...
    def validate(self, data):
        ...
        if data['date'] == today and data['start_time'] <= now:
            raise serializers.ValidationError(
                "Start time must be later than the current time for today.")
...
class BookedAppointmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['uuid', 'session_start', 'session_end',
                  'scheduling', 'booked_at', 'user_profile']
...
class SchedulingSerializerForAdmin(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'date', 'start_time', 'end_time',
                  'price', 'lawyer_profile', 'is_listed']
